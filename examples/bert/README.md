...
```
Then in the configuration file, we just provide the command line with the code path in the docker image. With the docker image, similarly to running a local job, we run:
