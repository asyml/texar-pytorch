...
class CtrlGenModel(object):
    ...
    def _build_model(self, inputs, vocab, gamma, lambda_g):
        ...
        start_tokens = torch.ones_like(inputs['labels']) * vocab.bos_token_id
        ...
        loss_d_clas = loss(clas_logits, inputs['labels'].type(torch.FloatTensor))
        ...
        loss_d_clas = loss(soft_logits, (1 - inputs['labels']).type(torch.FloatTensor))
