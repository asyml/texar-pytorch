...
class Conv1DClassifier(ClassifierBase):
    ...
    def default_hparams() -> Dict[str, Any]:
        ...
        2. Additional hyperparameters:
            ...
            "num_classes" : int
                ...
                classes is assumed to be equal to "out_features" of the final dense layer
                size of the encoder.

            "logit_layer_kwargs" : dict
                Keyword arguments for the logit Dense layer constructor,
                except for argument "out_features" which is set to "num_classes".
    ...
    def forward(self,  # type:ignore
                input: torch.Tensor, **kwargs: Any) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        logits = self._encoder(input, sequence_length=sequence_length, dtype=dtype)
