...
class BioBERTClassifier(PretrainedBioBERTMixin, BERTClassifier):
    r"""Classifier based on BioBERT modules.

    This is a combination of the
    :class:`~texar.torch.modules.BioBERTEncoder` with a classification
    layer. Both step-wise classification and sequence-level classification
    are supported, specified in :attr:`hparams`.

    Arguments are the same as in
    :class:`~texar.torch.modules.BioBERTEncoder`.

    Args:
        pretrained_model_name (optional): a `str`, the name
            of pre-trained model (e.g., ``biobert-v1.0-pmc``). Please refer to
    ...
    def default_hparams():
        ...
        .. code-block:: python
            ...
            {
                # (1) Same hyperparameters as in BioBERTEncoder
                ...
        ...
        1. Same hyperparameters as in
           :class:`~texar.torch.modules.BioBERTEncoder`.
           See the :meth:`~texar.torch.modules.BioBERTEncoder.default_hparams`.
           An instance of BioBERTEncoder is created for feature extraction.
        ...
        hparams = BioBERTEncoder.default_hparams()
        hparams.update({
            "num_classes": 2,
            "logit_layer_kwargs": None,
            "clas_strategy": "cls_time",
